  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-clash text-2xl font-semibold text-white">Reportes</h1>
          <p className="text-sm text-white/50 mt-1">Genera y descarga reportes de la plataforma</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          { label: 'Reportes programados', value: '6', change: '+2 este mes', color: 'green' },
      ...
      <div className="border border-white/10 rounded-lg p-12">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h2 className="font-clash text-xl font-semibold text-white mb-2">Módulo de reportes</h2>
          <p className="text-sm text-white/50 max-w-md">
            Esta funcionalidad estará disponible próximamente. Podrás generar reportes detallados de usuarios, eventos, organizaciones y más.
          </p>
          <Button
            variant="ghost"
