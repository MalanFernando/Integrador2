...
const add_favorito_dto_js_1 = require("./dto/add-favorito.dto.js");
...
], FavoritosController.prototype, "list", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_js_1.JwtAuthGuard),
    (0, common_1.Post)(),
    __param(0, (0, current_user_decorator_js_1.CurrentUser)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, add_favorito_dto_js_1.AddFavoritoDto]),
    __metadata("design:returntype", void 0)
], FavoritosController.prototype, "add", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_js_1.JwtAuthGuard),
    (0, common_1.Delete)(':eventoId'),
    __param(0, (0, current_user_decorator_js_1.CurrentUser)()),
...
exports.FavoritosController = FavoritosController = __decorate([
    ...
    __metadata("design:paramtypes", [favoritos_service_js_1.FavoritosService])
], FavoritosController);
