...
exports.AuditoriaModule = AuditoriaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([bitacora_entity_js_1.BitacoraAuditoria])],
        providers: [auditoria_service_js_1.AuditoriaService],
        exports: [auditoria_service_js_1.AuditoriaService],
    })
], AuditoriaModule);
